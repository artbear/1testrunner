...
Функция ПрочитатьТестовыеСлучаиОбъекта(Знач ТестОбъект, Знач МенеджерТестирования)
	...
	МассивТестовыхСлучаев = ПрочитатьТестовыеСлучаиОбъектаИзАннотаций(ТестОбъект, МенеджерТестирования);
...
//   Массив   - массив строк-имен методов тестового сценария
//
Функция ПрочитатьТестовыеСлучаиОбъектаИзАннотаций(Знач ТестОбъект, Знач МенеджерТестирования)
	...
	Для Каждого ТестовыйСлучай Из ТаблицаМетодов Цикл
		ДополнитьМассивПоАннотациям(ВремМассивТестовыхСлучаев, ТестовыйСлучай);
	КонецЦикла;
...
Процедура ДополнитьМассивПоАннотациям(ВхМассив, ТестовыйСлучай)
	...
	Для Каждого Аннотация Из ТестовыйСлучай.Аннотации Цикл
		...
		Если СтрНайти(Нрег(Аннотация.Имя), АннотацияТеста) > 0 Тогда
