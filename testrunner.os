...
Функция Версия() Экспорт
	Возврат Константы.ВерсияПродукта;	
КонецФункции // Версия()
...
//
// Параметры:
//   ПутьФайлаТеста - Строка
//   ПутьЛогФайлаJUnit - Строка
...
//
Функция ТестироватьФайл(Знач ПутьФайлаТеста, Знач ПутьЛогФайлаJUnit = Неопределено, Знач НаименованиеТестаДляЗапуска = Неопределено, 
...
КонецФункции // ТестироватьФайл(Знач ПутьФайлаТеста, Знач )

// Тестировать каталог тестов
//
// Параметры:
//   ПутьКаталогаТестов - Строка
//   ПутьЛогФайлаJUnit - Строка
//
//  Возвращаемое значение:
//   Строка - Результат тестирования
//
Функция ТестироватьКаталог(Знач ПутьКаталогаТестов, Знач ПутьЛогФайлаJUnit = Неопределено) Экспорт
...
Функция ОбработатьПараметрыЗапуска(МассивПараметров)
	...
	Если КомандаЗапуска = СтруктураПараметровЗапуска.Запустить Тогда
		ТестироватьФайл(ПутьКТестам, ПутьЛогФайлаJUnit, НаименованиеТестаДляЗапуска, НомерТестаДляЗапуска);
		Возврат Истина;
	КонецЕсли;
	Если КомандаЗапуска = СтруктураПараметровЗапуска.ЗапуститьКаталог Тогда
		ТестироватьКаталог(ПутьКТестам, ПутьЛогФайлаJUnit);
		Возврат Истина;
	КонецЕсли;
