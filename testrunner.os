...
Функция ВыполнитьПередТестом(ОписаниеТеста)
	...
	Возврат ВыполнитьПоАннотации(ОписаниеТеста, "перед");

КонецФункции	

Функция ВыполнитьПослеТеста(ОписаниеТеста)
	
	Возврат ВыполнитьПоАннотации(ОписаниеТеста, "после");
	
КонецФункции	

Функция ВыполнитьПоАннотации(ОписаниеТеста, СтрокаАннотации)
