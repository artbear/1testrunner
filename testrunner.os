...
Функция ПолучитьТестовыеСлучаи(ТестОбъект, ПолноеИмяОбъекта)
	...
	Попытка
		...
		МассивТестовыхСлучаев = ПрочитатьТестовыеСлучаиОбъекта(ТестОбъект, ЭтотОбъект, ПолноеИмяОбъекта);
...
//
Функция ПрочитатьТестовыеСлучаиОбъекта(Знач ТестОбъект, Знач МенеджерТестирования, ПолноеИмяОбъекта)
