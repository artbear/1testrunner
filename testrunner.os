		...
		Иначе
			...
			Для Каждого ТестовыйСлучай Из МассивТестовыхСлучаев Цикл
				...
				ИначеЕсли ТипЗнч(ТестовыйСлучай) = Тип("Структура")Тогда
					...
					ПредставлениеТеста = ТестовыйСлучай.Представление; // TODO ИмяТестовогоСлучая + Параметры
				Иначе
					ВызватьИсключение "Не умею обрабатывать описание тестового случая из ПолучитьСписокТестов, отличный от строки или структуры"; //TODO
				КонецЕсли;
